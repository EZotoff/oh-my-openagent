...
4. EXECUTE_OR_SUPERVISE -
   If self: surgical changes, match existing patterns, minimal diff. Never suppress type errors. Bugfix rule: fix minimally, never refactor while fixing. ${GPT_APPLY_PATCH_GUIDANCE}
